<template>
  <div class="blog">
    ...
    <p>
      In this project we have shown the epistemical developments and
      computational model of three different communication situations in a
      relatively simple logical manner. In addition, we have shown that it is
